...
export const BROWSER_SETTING_FIELDS: FieldSpec[] = [
  ...
  { key: "screenshotDir", label: "截图目录", type: "string", defaultValue: ".dsh-trio/screenshots" },
  ...
  { key: "liveViewPath", label: "实时画面 API 路径", type: "string", restart: true, defaultValue: "/trio/browser" },
];
